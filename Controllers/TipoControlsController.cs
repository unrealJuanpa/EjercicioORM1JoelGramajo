...
namespace EjercicioORM1JoelGramajo.Controllers
{
    public class TipoControlsController : Controller
    {
        ...
        {
            return View(db.TipoControl.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            TipoControl tipoControl = db.TipoControl.Find(id);
            if (tipoControl == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "IdTipoControl,NombreControl")] TipoControl tipoControl)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdTipoControl,NombreControl")] TipoControl tipoControl)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            TipoControl tipoControl = db.TipoControl.Find(id);
            db.TipoControl.Remove(tipoControl);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
